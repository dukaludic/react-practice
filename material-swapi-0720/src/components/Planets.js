...
class Planets extends Component {
    ...
    componentDidMount() {
        ...
        .then((res) => {this.setState({planetsArr: res.data.results, currentArr: res.data.results, loading: false})
    ...
    aridChangeHandler = (climate) => {
        ...
        if(this.state.aridCheckbox) {
            this.setState({aridCheckbox: false}, () => console.log(this.state.aridCheckbox))
            ...
            this.setState({aridCheckbox: true}, () => console.log(this.state.aridCheckbox))
    ...
    temperateChangeHandler = () => {
        ...
        if(this.state.temperateCheckbox) {
            this.setState({temperateCheckbox: false}, () => console.log(this.state.temperateCheckbox))
            ...
            this.setState({temperateCheckbox: true}, () => console.log(this.state.temperateCheckbox))
    ...
    tropicalChangeHandler = () => {
        ...
        if(this.state.tropicalCheckbox) {
            this.setState({tropicalCheckbox: false}, () => console.log(this.state.tropicalCheckbox))
            ...
            this.setState({tropicalCheckbox: true}, () => console.log(this.state.tropicalCheckbox))
    ...
    frozenChangeHandler = () => {
        ...
        if(this.state.frozenCheckbox) {
            this.setState({frozenCheckbox: false}, () => console.log(this.state.frozenCheckbox))
            ...
            this.setState({frozenCheckbox: true}, () => console.log(this.state.frozenCheckbox))
    ...
    murkyChangeHandler = () => {
        ...
        if(this.state.murkyCheckbox) {
            this.setState({murkyCheckbox: false}, () => console.log(this.state.murkyCheckbox))
            ...
            this.setState({murkyCheckbox: true}, () => console.log(this.state.murkyCheckbox))
    ...
    render() {
        ...
        return <div className="planetTable">
            {!this.state.loading && <div className="planetItemTitle">
                <div onClick={this.nameSort} style={{color: planetHl}} className="tableTitle">Planet</div>
                <div onClick={this.populationSort}  style={{color: populationHl}} className="tableTitle">Population</div>
                <div onClick={this.orbitalPeriodSort} style={{color: orbitalPeriodHl}} className="tableTitle">Orbital Period</div>
            </div>}
